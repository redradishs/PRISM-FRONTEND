...
import { NebiusAiService } from '../../services/nebius-ai.service';
...
export class GenerateAssessmentComponent {isMobile = window.innerWidth < 768;
  ...
  constructor(
    ...
    private nebiusAiService: NebiusAiService
  ) {
  ...
  generateQuestions(): void {
    ...
    this.nebiusAiService.generateAssessment(prompt).subscribe({
      next: (response) => {
        try {
  ...
  private constructPrompt(): string {
    ...
    if (this.extractedText && this.extractedText.trim() !== '') {
      contextPrompt = `Based on the following context: ${this.extractedText}\n`;
  ...
  "questions": [
    {
      ...
      "difficulty": "medium",
      "options": {
        "A": "To identify and fix defects after software release",
        "B": "To deliver working software in short cycles with continuous improvement",
        "C": "To reduce software development time and cost",
        "D": "To increase software complexity"
      },
      "answer": "B"
    },
     {
      "question": "Which phase of the SDLC involves creating detailed design specifications for the software?",
      "type": "short answer",
      "difficulty": "medium",
      "answer": "Detailed Design Phase"
    },
    {
      "question": "True or False: The V-Model is a SDLC model that starts with deployment.",
      "type": "true/false",
      "difficulty": "medium",
      "answer": false
    },
    {
      "question": "What are three types of testing activities performed during the SDLC?",
      "type": "enumeration",
      "difficulty": "medium",
      "answer": [
        "Unit Testing",
    ...
    {
      "question": "In Agile methodology, which artefact contains the business value priorities of product features?",
      "type": "short answer",
      "difficulty": "medium",
